<x-dashboard title="Create Contract">
    <!-- Page Heading -->
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 text-gray-800">Create New Contract</h1>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.contracts.store') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6" id="employee-field" style="display: none;">
                        <label for="employee_id" class="form-label">Employee <span class="text-danger">*</span></label>
                        <select name="contractable_id" id="employee_id" class="form-select select2">
                    ...
                    <div class="col-md-6" id="project-field" style="display: none;">
                        ...
                        <select name="contractable_id" id="project_id" class="form-select select2">
