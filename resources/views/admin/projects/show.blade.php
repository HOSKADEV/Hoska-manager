<x-dashboard title="Project Details - {{ $project->name }}">
    ...
    {{-- بطاقات المبالغ المالية فقط للمستخدمين غير الموظفين --}}
    @if(!$isEmployee)
        <div class="row mb-4">
            <div class="col-md-3">
                <div class="card text-white bg-primary h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text fs-4">{{ $currencySymbols[$project->currency] ?? '' }}
                            {{ number_format($project->total_amount, 2) }}</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <div class="card text-white bg-danger h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text fs-4">{{ $currencySymbols[$project->currency] ?? '' }}
                            {{ number_format($remainingAmount, 2) }}</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
        ...
        <div class="col-lg-7">
            <div class="card mb-5 shadow-sm h-100">
                ...
                <div class="card-body">
                    ...
                    {{-- إخفاء المرفقات للمستخدم الموظف --}}
                    @if(!$isEmployee)
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-danger">{{ $currencySymbols[$project->currency] ?? '' }}
                                        {{ number_format($remainingAmount, 2) }}</td>
                                </tr>
                                <tr>
