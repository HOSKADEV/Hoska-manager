<x-dashboard title="Wallet Details">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('admin.wallets.index') }}" class="btn btn-info"><i class="fas fa-long-arrow-alt-left"></i> Back to Wallets</a>
    </div>

    <div class="card mb-4">
        <div class="card-body">
            <h5>Balance: <span class="badge badge-success">${{ number_format($wallet->balance, 2) }}</span></h5>
